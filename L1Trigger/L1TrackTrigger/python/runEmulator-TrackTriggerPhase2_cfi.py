...
# Input source
inFile = 'file:../data/PU0_numEvent100.root'
...
process.output = cms.OutputModule(
    ...
    fileName = cms.untracked.string('../data/PU0_numEvent100_simEDM.root')
)

# Additional output definition
# TTree output file
process.load("CommonTools.UtilAlgos.TFileService_cfi")
process.TFileService.fileName = cms.string('../data/PU0_numEvent100_simEDM.root')
